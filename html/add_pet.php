...
if ($imagen && $imagen['error'] === UPLOAD_ERR_OK) {
    // Generar nombre de la imagen: nombre + raza + extensión
    ...
    // Directorio donde se guardarán las imágenes (debe existir y tener permisos)
    $directorioImagenes = __DIR__ . '/../img/';
...
if (!$stmt) {
    http_response_code(500);
    echo json_encode(array("message" => "Error en la preparación de la consulta: " . $conexion->error));
    exit();
}
