...
// Desactivar mensajes de error en producción
...
try {
    ...
    // PASO 1: Obtener información de la solicitud Y la mascota asociada ANTES de eliminar
    ...
    // PASO 2: Iniciar transacción para atomicidad
